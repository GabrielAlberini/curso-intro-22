...
pisosEdificio.push(5, 6, "terraza");
console.log("pisosEdificio", pisosEdificio);

const persona = {
  name: "Juana de Arco",
  age: "25",
  skills: ["MARTILLO", "ARCO", "HACHA", "FLECHA"],
};
...
//   copiaArray.push(letra.toLowerCase());
// }

const abecedarioOrdenado = abecedario.sort();
console.log("Ordenando array con letras en mayus", abecedarioOrdenado);
...
console.log("Ordenar con funcion de comparación", numbersOrdenados);
...
const obtenerNumeroMenor = (numeros) => {
  const arregloOrdenado = numeros.sort((a, b) => {
    return a - b;
  });
